...
const dashboard = new import_extra_typings.Command("dashboard").description("Open the dashboard in the browser").allowExcessArguments(false).option(
  "--no-open",
  ...
  if (deploymentName === void 0) {
    return await ctx.crash({
      ...
      printedMessage: `No Convex deployment configured, run \`${import_chalk.default.bold(
        "npx convex dev"
      )}\``
    });
  }
  ...
  if (options.open) {
    ...
    (0, import_context.logOutput)(ctx, loginUrl);
  }
});
