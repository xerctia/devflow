...
).allowExcessArguments(false).argument("[table]", "If specified, list documents in this table.").addOption(
...
async function listTables(ctx, deploymentUrl, adminKey, deploymentName, componentPath) {
