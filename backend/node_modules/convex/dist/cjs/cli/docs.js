...
async function openDocs(ctx, toOpen, cookie) {
  ...
  if (toOpen) {
    ...
    (0, import_context.logMessage)(ctx, import_chalk.default.green("Docs have launched! Check your browser."));
  } else {
    (0, import_context.logMessage)(ctx, import_chalk.default.green(`Find Convex docs here: ${docsUrl}`));
  }
}
