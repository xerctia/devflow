...
export const run = new Command("run").description("Run a function (query, mutation, or action) on your deployment").allowExcessArguments(false).argument(
  "functionName",
...
).addOption(new Option("--live-component-sources").hideHelp()).showHelpAfterError().action(async (functionName, argsString, options) => {
